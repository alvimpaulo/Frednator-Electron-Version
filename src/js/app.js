...
imgCreationWorker.onmessage = function(e) {
  ...
  //#start yellowDetector:app.js:receiveMessage#
  ...
  //#end yellowDetector:app.js:receiveMessage#
...
function videoTriedToBeStartedOrStopped(e) {
  ...
  if ($("#capture-param-btn").text() == "stop") {
    ...
    if (
      ...
      //! Used and generated by an external program, be careful when changing it
      //#start yellowDetector:app.js:videoTriedToBeStartedOrStopped#
      if (className.includes("Yellow Detector")) {
        imgCreationWorker.postMessage(["yellowDetector", "getDebugImageSize"]);
      }
      //#end yellowDetector:app.js:videoTriedToBeStartedOrStopped#
    }
  }
}
...
function detectorClicked(event) {
  ...
  //#start yellowDetector:app.js:detectorClicked#
  if (className.includes("Yellow Detector")) {
    imgCreationWorker.postMessage([
      "detectorStarted",
      document.getElementById("capture-param").value,
  ...
  //#end yellowDetector:app.js:detectorClicked#
}
